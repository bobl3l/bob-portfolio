...
import LogoLink from "./ui/linklogo";
...
export default function Home() {
  return (
    <div className="min-h-full">
      ...
      <main>
        <div className="mx-auto max-w-8xl px-4 py-6 sm:px-6 lg:px-8 bg-gray-900 flex flex-wrap">
          <div className="mx-auto max-w-4xl px-2 py-6 sm:px-6 lg:px-8">
            <h1 className="text-7xl font-black tracking-tight text-white">
              Hello, My name is
              <br />
              <span className="text-purple-700">Bob Liang.</span>
            </h1>
